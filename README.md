...
- orientation: ángulo de orientación inicial del radar en grados sexagesimales
...
métodos `run` y `stop` propios de cualquier clase que hereda de `Thread` para
poder ejecutarse como una hebra.
...
de visión es capaz de saber la distancia a la que se encuentra y la orientación
relativa respecto a la suya original. Sin embargo, nos interesa conocer las
